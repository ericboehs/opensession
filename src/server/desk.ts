...
- Read and manage the workspace's shared notes with the opensession-notes tools. Read a note before replacing its content, and only delete one when the user explicitly asks.
