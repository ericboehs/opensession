 ...
 *    twice.
 *  - Allocations persist in ~/.backstage-chats/sandbox-preview-ports.json so
...
// BACKSTAGE_CHATS_DIR is a live binding (test seam) — resolve per call.
function allocationsPath(): string {
  return `${BACKSTAGE_CHATS_DIR}/sandbox-preview-ports.json`;
}
