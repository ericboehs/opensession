...
var AttachmentType = /* @__PURE__ */ ((AttachmentType2) => {
  AttachmentType2["Chat"] = "CHAT";
  AttachmentType2["CustomTimelineEntry"] = "CUSTOM_TIMELINE_ENTRY";
  AttachmentType2["Discord"] = "DISCORD";
  AttachmentType2["Email"] = "EMAIL";
  AttachmentType2["MsTeams"] = "MS_TEAMS";
  AttachmentType2["Note"] = "NOTE";
  AttachmentType2["Slack"] = "SLACK";
  AttachmentType2["ThreadDiscussion"] = "THREAD_DISCUSSION";
  return AttachmentType2;
})(AttachmentType || {});
var ComponentBadgeColor = /* @__PURE__ */ ((ComponentBadgeColor2) => {
  ComponentBadgeColor2["Blue"] = "BLUE";
  ComponentBadgeColor2["Green"] = "GREEN";
  ComponentBadgeColor2["Grey"] = "GREY";
  ComponentBadgeColor2["Red"] = "RED";
  ComponentBadgeColor2["Yellow"] = "YELLOW";
  return ComponentBadgeColor2;
})(ComponentBadgeColor || {});
var ComponentDividerSpacingSize = /* @__PURE__ */ ((ComponentDividerSpacingSize2) => {
  ComponentDividerSpacingSize2["L"] = "L";
  ComponentDividerSpacingSize2["M"] = "M";
  ComponentDividerSpacingSize2["S"] = "S";
  ComponentDividerSpacingSize2["Xl"] = "XL";
  ComponentDividerSpacingSize2["Xs"] = "XS";
  return ComponentDividerSpacingSize2;
})(ComponentDividerSpacingSize || {});
var ComponentPlainTextColor = /* @__PURE__ */ ((ComponentPlainTextColor2) => {
  ComponentPlainTextColor2["Error"] = "ERROR";
  ComponentPlainTextColor2["Muted"] = "MUTED";
  ComponentPlainTextColor2["Normal"] = "NORMAL";
  ComponentPlainTextColor2["Success"] = "SUCCESS";
  ComponentPlainTextColor2["Warning"] = "WARNING";
  return ComponentPlainTextColor2;
})(ComponentPlainTextColor || {});
var ComponentPlainTextSize = /* @__PURE__ */ ((ComponentPlainTextSize2) => {
  ComponentPlainTextSize2["L"] = "L";
  ComponentPlainTextSize2["M"] = "M";
  ComponentPlainTextSize2["S"] = "S";
  return ComponentPlainTextSize2;
})(ComponentPlainTextSize || {});
var ComponentSpacerSize = /* @__PURE__ */ ((ComponentSpacerSize2) => {
  ComponentSpacerSize2["L"] = "L";
  ComponentSpacerSize2["M"] = "M";
  ComponentSpacerSize2["S"] = "S";
  ComponentSpacerSize2["Xl"] = "XL";
  ComponentSpacerSize2["Xs"] = "XS";
  return ComponentSpacerSize2;
})(ComponentSpacerSize || {});
var ComponentTextColor = /* @__PURE__ */ ((ComponentTextColor2) => {
  ComponentTextColor2["Error"] = "ERROR";
  ComponentTextColor2["Muted"] = "MUTED";
  ComponentTextColor2["Normal"] = "NORMAL";
  ComponentTextColor2["Success"] = "SUCCESS";
  ComponentTextColor2["Warning"] = "WARNING";
  return ComponentTextColor2;
})(ComponentTextColor || {});
var ComponentTextSize = /* @__PURE__ */ ((ComponentTextSize2) => {
  ComponentTextSize2["L"] = "L";
  ComponentTextSize2["M"] = "M";
  ComponentTextSize2["S"] = "S";
  return ComponentTextSize2;
})(ComponentTextSize || {});
var CustomersSortField = /* @__PURE__ */ ((CustomersSortField2) => {
  CustomersSortField2["FullName"] = "FULL_NAME";
  return CustomersSortField2;
})(CustomersSortField || {});
var DoneStatusDetail = /* @__PURE__ */ ((DoneStatusDetail2) => {
  DoneStatusDetail2["DoneAutomaticallySet"] = "DONE_AUTOMATICALLY_SET";
  DoneStatusDetail2["DoneManuallySet"] = "DONE_MANUALLY_SET";
  DoneStatusDetail2["Ignored"] = "IGNORED";
  DoneStatusDetail2["TimerExpired"] = "TIMER_EXPIRED";
  return DoneStatusDetail2;
})(DoneStatusDetail || {});
var MutationErrorType = /* @__PURE__ */ ((MutationErrorType2) => {
  MutationErrorType2["Forbidden"] = "FORBIDDEN";
  MutationErrorType2["Internal"] = "INTERNAL";
  MutationErrorType2["Validation"] = "VALIDATION";
  return MutationErrorType2;
})(MutationErrorType || {});
var MutationFieldErrorType = /* @__PURE__ */ ((MutationFieldErrorType2) => {
  MutationFieldErrorType2["NotFound"] = "NOT_FOUND";
  MutationFieldErrorType2["Required"] = "REQUIRED";
  MutationFieldErrorType2["Validation"] = "VALIDATION";
  return MutationFieldErrorType2;
})(MutationFieldErrorType || {});
var SnoozeStatusDetail = /* @__PURE__ */ ((SnoozeStatusDetail2) => {
  SnoozeStatusDetail2["WaitingForCustomer"] = "WAITING_FOR_CUSTOMER";
  SnoozeStatusDetail2["WaitingForDuration"] = "WAITING_FOR_DURATION";
  return SnoozeStatusDetail2;
})(SnoozeStatusDetail || {});
...
function getRequestId(headers) {
  const reqId = headers.get("apigw-requestid");
  if (reqId && typeof reqId === "string") {
    return reqId;
  }
}
async function request(ctx, args) {
  const query = typeof args.query === "string" ? args.query : graphql.print(args.query);
  try {
    const headers = {
      Authorization: `Bearer ${ctx.apiKey}`,
      "Content-Type": "application/json",
      "Plain-SDK": "typescript",
      "Plain-SDK-Version": version
    };
    ...
    if (status === 401 || status === 403) {
      ...
      return {
        error: {
          type: "forbidden",
          message: gqlErrors.length > 0 ? gqlErrors[0].message : "Authentication failed. Please check the provided API key.",
...
function unwrapData(result, unwrapFn) {
  if (result.error) {
    return {
      error: result.error
    };
...
class PlainClient {
   ...
   */
  async getUserByEmail(variables) {
    const res = await request(this.#ctx, {
      query: UserByEmailDocument,
      variables
    });
   ...
   */
  async getCustomerById(variables) {
    const res = await request(this.#ctx, {
   ...
   * If the customer is not found this will return null.
   */
  async getCustomerByExternalId(variables) {
    const res = await request(this.#ctx, {
   ...
   * If the customer is not found this will return null.
   */
  async getCustomerByEmail(variables) {
    const res = await request(this.#ctx, {
   ...
   */
  async getCustomerGroupById(variables) {
    const res = await request(this.#ctx, {
   ...
   */
  async getCustomerGroups(variables) {
    const res = await request(this.#ctx, {
   ...
   */
  async addCustomerToCustomerGroups(input) {
    const res = await request(this.#ctx, {
    ...
    return unwrapData(
      res,
      (q) => nonNullable(q.addCustomerToCustomerGroups.customerGroupMemberships)
    );
  }
  /**
   * Remove a customer from customer groups.
   */
  async removeCustomerFromCustomerGroups(input) {
    const res = await request(this.#ctx, {
  ...
  async getCustomerCustomerGroupMemberships(variables) {
    const res = await request(this.#ctx, {
    ...
    return unwrapData(res, (q) => {
      return {
        customerGroupMemberships: q.customer ? q.customer.customerGroupMemberships.edges.map((e) => e.node) : [],
        pageInfo: q.customer ? q.customer.customerGroupMemberships.pageInfo : null
      };
    });
  }
  async getCustomerTenantMemberships(variables) {
    const res = await request(this.#ctx, {
   ...
   */
  async createCustomerCardConfig(input) {
    const res = await request(this.#ctx, {
   ...
   */
  async updateCustomerCardConfig(input) {
    const res = await request(this.#ctx, {
   ...
   */
  async deleteCustomerCardConfig(input) {
    const res = await request(this.#ctx, {
   ...
   */
  async getThreadByRef(variables) {
    const res = await request(this.#ctx, {
   ...
   */
  async getThreadByExternalId(variables) {
    const res = await request(this.#ctx, {
   ...
   */
  async changeThreadPriority(input) {
    const res = await request(this.#ctx, {
   ...
   */
  async updateThreadTenant(input) {
    const res = await request(this.#ctx, {
  ...
  async createCustomerEvent(input) {
    const res = await request(this.#ctx, {
  ...
  async createWebhookTarget(input) {
    const res = await request(this.#ctx, {
  ...
  async updateWebhookTarget(input) {
    const res = await request(this.#ctx, {
  ...
  async deleteWebhookTarget(input) {
    const res = await request(this.#ctx, {
   ...
   */
  async getWebhookTargetById(variables) {
    const res = await request(this.#ctx, {
  ...
  async setCustomerTenants(input) {
    const res = await request(this.#ctx, {
  ...
  async addCustomerToTenants(input) {
    const res = await request(this.#ctx, {
  ...
  async removeCustomerFromTenants(input) {
    const res = await request(this.#ctx, {
  ...
  async updateCustomerCompany(input) {
    const res = await request(this.#ctx, {
    ...
    return unwrapData(res, (res2) => nonNullable(res2.updateCustomerCompany.customer));
  }
  async getTierById(variables) {
    const res = await request(this.#ctx, {
      query: TierDocument,
      variables
    });
  ...
  async removeMembersFromTier(input) {
    const res = await request(this.#ctx, {
...
class PlainWebhookError extends Error {
}
class PlainWebhookSignatureVerificationError extends PlainWebhookError {
}
class PlainWebhookVersionMismatchError extends PlainWebhookError {
...
class PlainWebhookPayloadError extends PlainWebhookError {
}

var title = "Webhooks schema definition";
var type = "object";
var properties = {
	timestamp: {
...
var description = "Webhook request";
var definitions = {
	id: {
		type: "string",
		minLength: 1,
...
function verifyWebhookSignature(payload, signature, secret) {
  ...
  const expectedSignature = crypto__namespace.createHmac("sha256", secret).update(payload, "utf8").digest("hex");
...
function spacingSizeToEnum$1(size) {
  if (!size) {
    return null;
  }
  const map = {
...
function dividerComponent(args) {
  return {
    componentDivider: {
      dividerSpacingSize: spacingSizeToEnum$1(args.spacingSize)
    }
  };
}
...
function textSizeToEnum$1(size) {
  if (!size) {
    return null;
  }
  return ComponentPlainTextSize[size];
}
function textColorToEnum$1(color) {
  if (!color) {
    return null;
  }
  const map = {
...
function plainTextComponent(args) {
  return {
    componentPlainText: {
      plainText: args.text,
      plainTextColor: textColorToEnum$1(args.color),
      plainTextSize: textSizeToEnum$1(args.size)
    }
  };
}
...
function spacingSizeToEnum(size) {
  if (!size) {
    return null;
  }
  const map = {
...
function textSizeToEnum(size) {
  if (!size) {
    return null;
  }
  return ComponentTextSize[size];
}
function textColorToEnum(color) {
  if (!color) {
    return null;
  }
  const map = {
...
exports.ComponentBadgeColor = ComponentBadgeColor;
exports.ComponentDividerSpacingSize = ComponentDividerSpacingSize;
exports.ComponentPlainTextColor = ComponentPlainTextColor;
exports.ComponentPlainTextSize = ComponentPlainTextSize;
exports.ComponentSpacerSize = ComponentSpacerSize;
exports.ComponentTextColor = ComponentTextColor;
exports.ComponentTextSize = ComponentTextSize;
exports.CustomersSortField = CustomersSortField;
exports.DoneStatusDetail = DoneStatusDetail;
exports.MutationErrorType = MutationErrorType;
exports.MutationFieldErrorType = MutationFieldErrorType;
exports.PlainClient = PlainClient;
exports.PlainWebhookError = PlainWebhookError;
exports.PlainWebhookPayloadError = PlainWebhookPayloadError;
exports.PlainWebhookSignatureVerificationError = PlainWebhookSignatureVerificationError;
exports.PlainWebhookVersionMismatchError = PlainWebhookVersionMismatchError;
exports.SnoozeStatusDetail = SnoozeStatusDetail;
exports.SortDirection = SortDirection;
exports.ThreadFieldSchemaType = ThreadFieldSchemaType;
exports.ThreadStatus = ThreadStatus;
exports.ThreadsSortField = ThreadsSortField;
exports.TodoStatusDetail = TodoStatusDetail;
exports.UpsertResult = UpsertResult;
exports.UserStatus = UserStatus;
exports.parsePlainWebhook = parsePlainWebhook;
exports.uiComponent = uiComponent;
exports.verifyPlainWebhook = verifyPlainWebhook;
