import { FileTreeIcons, RemappedIcon } from "../iconConfig.js";
import { ContextMenuAnchorRect, GitStatusEntry } from "../publicTypes.js";
import { FileTreeDensity } from "./density.js";
import { FileTreePreparedInput } from "../preparedInput.js";

//#region src/model/publicTypes.d.ts
...
type FileTreeSortComparator = (left: FileTreeSortEntry, right: FileTreeSortEntry) => number;
...
type FileTreeControllerOptions = FileTreeControllerBehaviorOptions & FileTreeInputOptions;
...
type FileTreeMutationSemanticEvent = FileTreeAddEvent | FileTreeRemoveEvent | FileTreeMoveEvent | FileTreeResetEvent;
...
type FileTreeMutationEventForType<TType extends FileTreeMutationEventType | '*'> = TType extends '*' ? FileTreeMutationEvent : Extract<FileTreeMutationEvent, {
  operation: TType;
}>;
interface FileTreeResetOptions {
  initialExpandedPaths?: readonly FileTreePublicId[];
  preparedInput?: FileTreePreparedInput;
}
...
type FileTreeSelectionChangeListener = (selectedPaths: readonly FileTreePublicId[]) => void;
...
type FileTreeRowDecoration = FileTreeRowDecorationText | FileTreeRowDecorationIcon;
interface FileTreeRowDecorationContext {
  item: FileTreeContextMenuItem;
  row: FileTreeVisibleRow;
}
type FileTreeRowDecorationRenderer = (context: FileTreeRowDecorationContext) => FileTreeRowDecoration | null;
//#endregion
export { FileTreeAddEvent, FileTreeBatchEvent, FileTreeBatchOperation, FileTreeCollisionStrategy, FileTreeCompositionOptions, FileTreeContextMenuButtonVisibility, FileTreeContextMenuCompositionOptions, FileTreeContextMenuItem, FileTreeContextMenuOpenContext, FileTreeContextMenuTriggerMode, FileTreeControllerOptions, FileTreeDirectoryHandle, FileTreeDragAndDropConfig, FileTreeDropContext, FileTreeDropResult, FileTreeDropTarget, FileTreeFileHandle, FileTreeHeaderCompositionOptions, FileTreeHydrationProps, FileTreeInitialExpansion, FileTreeItemHandle, FileTreeItemHandleBase, FileTreeListener, FileTreeMoveEvent, FileTreeMoveOptions, FileTreeMutationEvent, FileTreeMutationEventForType, FileTreeMutationEventInvalidation, FileTreeMutationEventType, FileTreeMutationHandle, FileTreeMutationSemanticEvent, FileTreeOptions, FileTreePublicId, FileTreeRemoveEvent, FileTreeRemoveOptions, FileTreeRenameEvent, FileTreeRenamingConfig, FileTreeRenamingItem, FileTreeRenderOptions, FileTreeRenderProps, FileTreeResetEvent, FileTreeResetOptions, FileTreeRowDecoration, FileTreeRowDecorationContext, FileTreeRowDecorationIcon, FileTreeRowDecorationRenderer, FileTreeRowDecorationText, FileTreeScrollOffset, FileTreeScrollToPathOptions, FileTreeSearchBlurBehavior, FileTreeSearchChangeListener, FileTreeSearchMode, FileTreeSearchSessionHandle, FileTreeSelectionChangeListener, FileTreeSortComparator, FileTreeSortEntry, FileTreeSsrPayload, FileTreeVisibleRow, FileTreeVisibleSegment };
