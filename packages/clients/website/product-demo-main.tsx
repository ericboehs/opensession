...
const sessions: UnifiedSession[] = [
	...
	...([
		...
		["search-ranking", "Tune search ranking for short queries", 358, 640, "openai/gpt-5.6-sol"],
		["mobile-keyboard", "Stop the keyboard covering the composer", 402, 705, "anthropic/claude-sonnet-5"],
		["seat-billing", "Prorate seats when a teammate leaves", 448, 760, "anthropic/claude-opus-5"],
		["slow-migration", "Split the slow migration into batches", 512, 828, "openai/gpt-5.6-terra"],
		["sso-errors", "Explain SSO errors in plain language", 566, 902, "anthropic/claude-sonnet-5"],
		["webhook-docs", "Document the webhook payloads", 624, 980, "openai/gpt-5.6-sol"],
		["retry-backoff", "Back off retries after a rate limit", 690, 1050, "anthropic/claude-opus-5"],
		["export-csv", "Export a workspace to CSV", 754, 1128, "openai/gpt-5.6-sol"],
