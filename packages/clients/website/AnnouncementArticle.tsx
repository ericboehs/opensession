...
export function AnnouncementArticle({
	...
	return (
		<article className="announcement-article">
			...
			<p>
				Everyone uses Open Session at Tella, and not just for product development
				either. Open Session helps us with operations, support, data analysis,
				finance, and general AI chat.
			</p>

			<p>
				Since July, 80% of code shipped to Tella has come from Open Session. It’s
			...
			<p>
				...
				conversations, Git worktrees, PRs, automations, and execution that you can
				run on your own machines or in sandboxes.
			</p>

			<p>
				Because it’s open source, you can fork it and fully adapt it to your
				company. But Open Session is also extensible at the product layer. You can
				connect MCPs, skills, automation recipes, integrations, sandbox providers
				and more.
			</p>
			...
			<p>
				...
				days pursuing a goal, or launch them from tools like Slack, Linear, Plain,
				and GitHub. Sessions can also delegate work to others. Regardless of how a
			...
			<p>
				...
				you can do fun things like run as many agents as your server can handle,
				close your laptop while an agent is working, and code from your phone. But
				we’ve taken things further and made Open Session fully collaborative (for
				humans).
			</p>
			...
			<p>
				...
				want several people prompting in the same session.
			</p>
			...
			<p>
				...
				agent that can use your entire server as context. You can ask it questions
				like “what’s being worked on right now?” or “is anything stuck in Project
				X?”. You can also use it for starting work more casually by first exploring
				ideas and doing research. The desk mode agent will then kick off more
			...
			<p>
				...
				a repeatable task and it will run periodic sessions required to complete
				the task. At Tella we have automations that review PRs, look for sloppy
				code, maintain product documentation, monitor infosec and a bunch more. You
				can connect automations to another Open Session feature called Reports. An
				automation will generate a periodic report with whatever findings you
				requested. We have reports for Tella’s SEO performance, feature requests,
			...
			<p>
				...
				demo videos. For simple changes, you might decide to ship it based only on
				the walkthrough, but the more important thing is how walkthroughs speed up
				the iteration loop. When you have multiple agents running it’s a pain to
				manually test and verify every iteration - too much context and surface
			...
			<p>
				The names I mention above are the big dogs, but there’s a big long tail of
				smaller startups in this space. And there are many teams, like ours, who’ve
				built and open sourced their own. So in such a busy space it’s valid to
				ask: why bother doing this at all?
			</p>

			<p>
				The answer is just that it’s an exciting time to be building software. So
				much is changing, and it’s so easy to make something yourself, and the best
				way to figure out where everything is headed is to decide the direction
				yourself.
			</p>

			<p>
				Open Session is our take on how software and startups will be built in the
				future. We hope you like it.
			</p>
