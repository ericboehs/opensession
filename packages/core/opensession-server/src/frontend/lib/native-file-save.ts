...
export function shouldUseNativeIOSShare(input: {
	...
	return isiOS && (input.standalone || input.displayModeStandalone) && input.hasShare;
}
...
export async function saveFileWithNativeShare(url: string, name: string): Promise<void> {
