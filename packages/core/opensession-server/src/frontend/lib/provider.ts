...
const CODESTORAGE: Provider = { key: "codestorage", name: "Code Storage", changeNoun: "change", changeAbbr: "CR" };
...
export function providerFromUrl(url: string | null | undefined): Provider {
	...
	if (host === "code.storage" || host.endsWith(".code.storage")) return CODESTORAGE;
 ...
 */
export function prCapabilities(caps?: PrHostCapabilities | null): PrHostCapabilities {
