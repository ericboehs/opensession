...
export function SandboxProviderLogo({ provider }: { provider: SandboxProvider }) {
	if (provider === "box") {
		return (
			<SandboxProviderTile {...stylex.props(sx.bgWhite, sx.text111)}>
	...
	if (provider === "daytona") {
		return (
			<SandboxProviderTile {...stylex.props(sx.bgWhite)}>
	...
	if (provider === "microvm") {
		return (
			<SandboxProviderTile {...stylex.props(sx.bg111318)}>
	...
	if (provider === "docker") {
		return (
			<SandboxProviderTile {...stylex.props(sx.bgEdf7ff, sx.text2496ed)}>
	...
	return (
		<SandboxProviderTile {...stylex.props(sx.bg07140d, sx.text62de61)}>
			<svg viewBox="0 0 24 24" {...stylex.props(sx.size6)} fill="currentColor" aria-hidden="true">
