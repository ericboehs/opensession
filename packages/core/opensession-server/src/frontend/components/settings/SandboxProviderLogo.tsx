...
export function SandboxProviderLogo({ provider }: { provider: SandboxProvider }) {
	...
	if (provider === "microvm") {
		return (
			<span className="flex size-10 shrink-0 items-center justify-center overflow-hidden rounded-lg bg-[#111318]" style={tileStyle}>
	...
	if (provider === "docker") {
		return (
			<span className="flex size-10 shrink-0 items-center justify-center overflow-hidden rounded-lg bg-[#edf7ff] text-[#2496ed]" style={tileStyle}>
	...
	return (
		<span className="flex size-10 shrink-0 items-center justify-center overflow-hidden rounded-lg bg-[#07140d] text-[#62de61]" style={tileStyle}>
			<svg viewBox="0 0 24 24" className="size-6" fill="currentColor" aria-hidden="true">
