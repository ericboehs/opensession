...
export const type = stylex.create({
	...
	itemTitle: { fontSize: "var(--type-item-title)" },
	dialogTitle: { fontSize: "var(--type-dialog-title)" },
	sectionTitle: { fontSize: "var(--type-section-title)" },
	pageTitle: { fontSize: "var(--type-page-title)" },
