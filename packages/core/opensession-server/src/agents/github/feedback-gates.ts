...
const STOPWORDS = new Set([
  "the", "this", "that", "these", "those", "into", "for", "with", "and",
  "are", "was", "were", "has", "have", "had", "its", "can", "could",
  "should", "would", "will", "not", "but", "you", "your", "here", "there",
  "when", "then", "than", "from", "also", "may", "might", "been", "being",
]);
